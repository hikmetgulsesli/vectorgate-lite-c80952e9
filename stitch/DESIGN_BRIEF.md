...
- VectorGate Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called VectorGate Lite. It should be a full-viewport timing/reflex arcade game where the player guides a moving signal through rotating gates, scores points for clean passes, loses health on collisions, and can pause/resume. Include a gameplay surface, settings surface, pause/gam…
...
- Gameplay - VectorGate Lite
- Game Settings - VectorGate Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - VectorGate Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - VectorGate Lite
